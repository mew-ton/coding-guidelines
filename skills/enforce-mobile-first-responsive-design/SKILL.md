---
name: enforce-mobile-first-responsive-design
description: "Enforces mobile-first responsive design by requiring that default (unprefixed) Tailwind classes target mobile viewports and breakpoints target larger screens. Use when writing or reviewing responsive layout and styling. Do not use for print stylesheets or other non-screen media contexts."
metadata:
  type: "indicator"
  keywords: "tailwind, responsive, mobile-first, breakpoints"
---
