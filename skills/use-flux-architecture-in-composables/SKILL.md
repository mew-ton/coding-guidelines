---
name: use-flux-architecture-in-composables
description: "Enforces Flux-style decomposition of Vue/React composables into distinct roles (State, Actions, Getters, Utils) to avoid monolithic composables. Use when writing or reviewing a composable that is growing beyond a single concern. Do not use for trivial one-purpose composables where splitting adds no clarity."
metadata:
  type: "indicator"
  keywords: "composable, hook, state, reactive, action, getter, flux, decomposition"
---
