---
name: separate-queries-from-handlers
description: "Enforces moving SQL/ORM queries out of HTTP handlers and into a dedicated Repository or Query Service layer. Use when writing or reviewing handler functions that contain inline database queries. Do not use for simple scripts or CLIs where a full layered architecture is unnecessary overhead."
metadata:
  type: "indicator"
  keywords: "backend, architecture, database, repository, separation-of-concerns"
---
