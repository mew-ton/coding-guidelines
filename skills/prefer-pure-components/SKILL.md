---
name: prefer-pure-components
description: "Enforces a pure Props-In / Events-Out component design to maximize testability and reusability. Use when designing or reviewing presentational UI components. Do not use for container or page-level components whose explicit responsibility is to manage side effects and state."
metadata:
  type: "indicator"
  keywords: "component, props, event, sideeffect, coupling, testability, purity, predictability, functional"
---
