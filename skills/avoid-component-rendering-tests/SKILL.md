---
name: avoid-component-rendering-tests
description: "Minimizes reliance on full component mount tests by extracting testable logic and mocking child components when rendering is necessary. Use when writing tests for frontend components. Do not use to prohibit all rendering tests — snapshot or integration tests for critical UI flows are still acceptable with justification."
metadata:
  type: "indicator"
  keywords: "frontend, rendering, mount, integration, mock, shallow"
---
