---
name: transform-data-before-passing-to-components
description: "Enforces that data transformation (filtering, sorting, reshaping) happens in the API or logic layer, not inside components. Use when a component template contains conditional logic or data manipulation beyond simple formatting. Do not use for purely cosmetic formatting (e.g. date display, number rounding) that is inherently display-specific."
metadata:
  type: "indicator"
  keywords: "transformation, mapper, viewmodel, logic, minimal, display-ready"
---
