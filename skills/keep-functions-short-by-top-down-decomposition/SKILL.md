---
name: keep-functions-short-by-top-down-decomposition
description: "Enforces short functions through top-down decomposition and comments-first development to improve readability. Use when writing or reviewing functions that exceed a single screenful of logic. Do not use for intentionally thin wrapper or delegation functions that are short by design."
metadata:
  type: "indicator"
  keywords: "readability, maintainability, function, length, complexity, size, decomposition"
---
