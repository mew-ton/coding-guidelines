...
description: "Enforces the idiomatic Go table-driven test pattern using a slice of named test cases for testing multiple input/output combinations. Use when writing Go tests for a function with multiple distinct input scenarios. Do not use for tests that require fundamentally different setup or teardown per case, where table-driven structure would obscure rather than clarify."
metadata:
  type: "indicator"
  keywords: "testing, go, table-driven, idiomatic"
---
