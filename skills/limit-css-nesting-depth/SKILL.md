---
name: limit-css-nesting-depth
description: "Limits CSS rule nesting to a maximum of 3 levels to control specificity growth and file bloat. Use when writing or reviewing nested CSS in preprocessors or native CSS nesting. Do not use for keyframe or media query nesting which does not contribute to selector specificity."
metadata:
  type: "indicator"
  keywords: "css, nesting, preprocessor, performance, specificity"
---
