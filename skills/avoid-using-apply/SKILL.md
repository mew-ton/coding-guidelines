---
name: avoid-using-apply
description: "Prohibits the @apply directive in CSS files to preserve Tailwind's utility-first architecture and prevent abstraction leakage. Use when writing or reviewing CSS/SCSS files in a Tailwind project. Do not apply to Tailwind's own base layer definitions or third-party library integration files."
metadata:
  type: "constraint"
  keywords: "tailwind, css, best-practice, utility-first, maintainability"
---
