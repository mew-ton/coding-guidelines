---
name: avoid-unrequested-scope-expansion
description: "Prevents scope creep by keeping implementations strictly focused on the requested task without adding unrequested features or refactors. Use when planning or reviewing implementations against a stated requirement. Do not use to prevent clarifying questions or to block a fix that is a necessary precondition of the requested change."
metadata:
  type: "indicator"
