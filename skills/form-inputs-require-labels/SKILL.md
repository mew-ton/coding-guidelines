---
name: form-inputs-require-labels
description: "Enforces that every HTML form input has an associated label element or aria-label for screen reader accessibility. Use when writing or reviewing HTML forms. Do not use for hidden inputs (type=\"hidden\") where a visible label is not applicable."
metadata:
  type: "constraint"
  keywords: "html, accessibility, a11y, forms, labels"
---
