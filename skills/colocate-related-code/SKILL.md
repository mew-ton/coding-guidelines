---
name: colocate-related-code
description: "Enforces colocation of related files (tests, styles, utils, types) next to the code that uses them instead of in global folders. Use when adding new files to a project to decide where they should live. Do not use to relocate files that are genuinely shared across many unrelated modules — those belong in shared/global directories."
metadata:
  type: "indicator"
  keywords: "clean-code, structure, organization, colocation, modularity"
---
