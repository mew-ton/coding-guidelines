---
name: limit-function-arguments
description: "Limits function arguments to a maximum of 3, requiring an options object or struct for more complex inputs. Use when defining or reviewing functions with many parameters. Do not use for functions that intentionally mirror external APIs or library signatures where changing the signature would break compatibility."
metadata:
  type: "indicator"
  keywords: "clean-code, function, arguments, parameters, readability"
---
