...
description: "Enforces a soft 100-line limit on frontend components to encourage decomposition and readability. Use when writing or reviewing components that are growing in length. Do not use for generated or configuration-heavy components where line count does not reflect actual complexity."
metadata:
  type: "indicator"
  keywords: "component, file, function, large, long, complex, decomposition, readability, size, lines"
---
