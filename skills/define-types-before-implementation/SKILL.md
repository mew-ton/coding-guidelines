---
name: define-types-before-implementation
description: "Enforces a design-first workflow where data structures and interfaces are defined before implementation begins. Use when starting a new feature, function, or module to establish the data contract upfront. Do not use for quick fixes or single-line utilities where defining a type adds no clarity."
metadata:
  type: "indicator"
  keywords: "type, interface, contract, process, no-any, specification, design-first"
---
