---
name: prefer-server-islands-for-dynamic-content
description: "Guides selection of Astro Server Islands (server:defer) for personalized or dynamic content to keep the page shell cacheable. Use when implementing components that fetch user-specific or frequently changing data. Do not use for fully static content or components that must render synchronously for SEO."
metadata:
  type: "indicator"
  keywords: "astro, server-islands, caching, dynamism"
---
