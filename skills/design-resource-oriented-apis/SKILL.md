---
name: design-resource-oriented-apis
description: "Enforces resource-oriented REST API design by using nouns in paths and HTTP methods for actions. Use when designing or reviewing REST API endpoints. Do not use for RPC-style APIs, GraphQL, or WebSocket interfaces where resource-oriented conventions do not apply."
metadata:
  type: "indicator"
  keywords: "backend, api, rest, resource-oriented, http"
---
