---
name: organize-page-specific-components
description: "Enforces placement of page-specific components in a dedicated components/pages/[PageName]/ directory to prevent global namespace pollution. Use when creating a component that will only be used by a single page. Do not use for shared components referenced by two or more pages or routes."
metadata:
  type: "indicator"
  keywords: "component, page, directory, clutter, organization, scaling, encapsulation, cohesion, structure"
---
