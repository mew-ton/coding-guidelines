---
name: component-props-naming-and-structure
description: "Enforces HTML-attribute-style prop naming and primitive-first prop design for frontend components. Use when writing or reviewing component interfaces. Do not use when a complex object is a genuine domain model that the component is explicitly designed to consume."
metadata:
  type: "indicator"
  keywords: "frontend, component, props, naming, primitives, html-style"
---
