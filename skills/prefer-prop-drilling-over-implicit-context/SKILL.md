---
name: prefer-prop-drilling-over-implicit-context
description: "Enforces explicit prop drilling over implicit mechanisms like Provide/Inject or global state for clear data flow. Use when passing data through two or three component layers. Do not use when data must be shared across deeply nested trees or completely unrelated component subtrees where prop drilling would require changes to many intermediate components."
metadata:
  type: "indicator"
  keywords: "props, data-flow, context, implicit, magic, obscure, traceability, explicit, drilling"
---
