---
name: sort-tailwind-classes-automatically
description: "Enforces automated sorting of Tailwind utility classes (via Prettier plugin or similar) for consistency and readability. Use when setting up a project or reviewing unsorted class lists. Do not manually sort classes — always delegate to the configured tooling."
metadata:
  type: "indicator"
  keywords: "tailwind, readability, tooling, sorting"
---
