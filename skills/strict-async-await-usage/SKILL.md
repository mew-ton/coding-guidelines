---
name: strict-async-await-usage
description: "Enforces async/await over .then()/.catch() chains for consistent asynchronous code and predictable error handling. Use when writing or reviewing asynchronous TypeScript or JavaScript. Do not use in environments that do not support async/await (e.g. legacy Node.js without transpilation)."
metadata:
  type: "constraint"
  keywords: "typescript, async, promise, readability, error-handling"
---
