---
name: prevent-dead-code-and-asset-mismatch
description: "Prevents dead code and asset mismatches by ensuring application logic and static resources stay synchronized when either is modified. Use when deleting, renaming, or relocating code or asset files. Do not use when code is intentionally feature-flagged or disabled for a temporary period with a documented plan to restore it."
metadata:
  type: "constraint"
