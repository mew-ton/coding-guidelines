---
name: avoid-using-important
description: "Prohibits the use of !important in CSS to preserve the natural cascade and prevent specificity escalation. Use when writing or reviewing any CSS declaration. Do not use to block third-party library overrides where !important is the only available mechanism."
metadata:
  type: "constraint"
  keywords: "css, specificity, cascade, maintainability"
---
