---
name: use-valid-heading-hierarchy
description: "Enforces a valid heading hierarchy (h1–h6) that does not skip levels and uses only one h1 per page. Use when writing or reviewing HTML page content. Do not use for email templates or embedded widgets where heading hierarchy is dictated by an external container."
metadata:
  type: "constraint"
  keywords: "html, accessibility, seo, headings, structure"
---
