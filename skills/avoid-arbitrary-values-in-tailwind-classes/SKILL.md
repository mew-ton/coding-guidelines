---
name: avoid-arbitrary-values-in-tailwind-classes
description: "Prohibits Tailwind arbitrary values (e.g. w-[17px]) to enforce design system token consistency. Use when writing or reviewing Tailwind class lists. Do not use when a value is intentionally one-off and cannot be expressed by any existing token (e.g. a pixel-perfect third-party embed constraint)."
metadata:
  type: "constraint"
  keywords: "tailwind, consistency, design-system, maintenance"
---
