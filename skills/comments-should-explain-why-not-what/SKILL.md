...
description: "Enforces that code comments explain the rationale and context behind decisions rather than restating what the code does. Use when writing or reviewing comments in any source file. Do not use to block all comments — only to redirect them toward explaining why, not what."
metadata:
  type: "indicator"
  keywords: "comments, documentation, readability, context"
---
