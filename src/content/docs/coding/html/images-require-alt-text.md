...
description: Enforces the presence of an alt attribute on all img tags for accessibility and SEO. Use when writing or reviewing any HTML that includes images. Do not skip even for decorative images — use empty alt="" in that case.
skill-metadata:
  type: constraint
  keywords: "html, accessibility, a11y, images, alt, seo, screen-reader"
---
