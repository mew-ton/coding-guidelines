...
description: Enforces use of semantic HTML elements (article, section, nav, etc.) over generic div/span for accessibility and SEO. Use when writing or reviewing HTML structure. Do not use to reject explicit ARIA role attributes, which are an acceptable alternative when a semantic element is unavailable.
skill-metadata:
  type: indicator
  keywords: "html, semantic, accessibility, seo, structure, role"
---
